...
@section('content')
            ...
            <div class="relative grid grid-cols-1 md:grid-cols-2 max-w-screen-xl mx-auto p-6 text-white">
                <div>
                    ...
                    <p class="text-base md:text-lg mb-4">
                        FASTTAX dapat membantu anda mengoptimalkan efisiensi pajak dan berkontribusi pada strategi
                        perusahaan secara keseluruhan melalui perumusan strategi perpajakan yang efektif dan perencanaan
                        pajak yang inovatif dan juga mematuhi semua peraturan peraturan yang ada.
                    </p>
                    <p class="text-base md:text-lg mb-4">
                        FASTTAX memiliki konsultan pajak yang berpengalaman dan professional dalam menangani masalah
                        keuangan dan pajak di Perusahaan PMDN maupun PMA.
                    </p>
                </div>
            </div>
        </section>
    ...
    <main>
        <section class="max-w-screen-xl mx-auto p-6 mt-4 mb-10 relative">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
                <div class=" bg-white  border border-danger-300 rounded-md overflow-hidden flex flex-col">
                    ...
                    <a href="{{ url('https://api.whatsapp.com/send?phone=6282225288269&text=Halo,%20saya%20ingin%20bertanya%20mengenai%20layanan%20FASTLEGAL') }}"
                        ...
                        <span class="pl-2"> Hubungi Kami</span>
                    </a>
                ...
                <div class=" bg-white  border border-danger-300 rounded-md overflow-hidden flex flex-col">
                    ...
                    <div class="p-4 flex-grow">
                        ...
                        <p class="text-gray-600 text-sm flex">
                            ...
                            <span> Ekposur Pendirian Permanen</span>
                        </p>
                        <p class="text-gray-600 text-sm flex">
                            <svg class="w-5 h-5 text-green-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                width="24" height="24" fill="none" viewBox="0 0 24 24">
                            ...
                            <span> Aplikasi Perjanjian Pajak</span>
                        </p>
                    </div>
                ...
                <div class=" bg-white  border border-danger-300 rounded-md overflow-hidden flex flex-col">
                    ...
                    <div class="p-4 flex-grow">
                        ...
                        <p class="text-gray-600 text-sm flex">
                            ...
                            <span> Pemeriksaan Pajak, Keberatan dan Banding</span>
                        </p>
                        <p class="text-gray-600 text-sm flex">
                            <svg class="w-5 h-5 text-green-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                width="24" height="24" fill="none" viewBox="0 0 24 24">
                            ...
                            <span> Prosesi Mahkamah Agung</span>
                        </p>
                        <p class="text-gray-600 text-sm flex">
                            <svg class="w-5 h-5 text-green-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                width="24" height="24" fill="none" viewBox="0 0 24 24">
                            ...
                            <span> Audit Pajak Pasca Merger</span>
                        </p>
                    </div>
                ...
                <div class=" bg-white  border border-danger-300 rounded-md overflow-hidden flex flex-col">
                    ...
                    <div class="p-4 flex-grow">
                        ...
                        <p class="text-gray-600 text-sm flex">
                            ...
                            <span> Penilaian dan Pertahanan Resiko</span>
                        </p>
                        <p class="text-gray-600 text-sm flex">
                            <svg class="w-5 h-5 text-green-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                width="24" height="24" fill="none" viewBox="0 0 24 24">
                ...
                <div class=" bg-white  border border-danger-300 rounded-md overflow-hidden flex flex-col">
                    ...
                    <div class="p-4 flex-grow">
                        ...
                        <p class="text-gray-600 text-sm flex">
                            ...
                            <span> Investasi: Pendirian dan Kepatuhan PMA</span>
                        </p>
                        <p class="text-gray-600 text-sm flex">
                            <svg class="w-5 h-5 text-green-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                width="24" height="24" fill="none" viewBox="0 0 24 24">
                ...
                <div class=" bg-white  border border-danger-300 rounded-md overflow-hidden flex flex-col">
                    ...
                    <div class="p-4 flex-grow">
                        ...
                        <p class="text-gray-600 text-sm flex">
                            ...
                            <span> Penilaian dan Klafikasi</span>
                        </p>
                        <p class="text-gray-600 text-sm flex">
                            <svg class="w-5 h-5 text-green-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                width="24" height="24" fill="none" viewBox="0 0 24 24">
                        ...
                        <p class="text-gray-600 text-sm flex">
                            ...
                            <span> Perencanaan Bea Cukai</span>
                        </p>
                    </div>
                ...
                <div class=" bg-white  border border-danger-300 rounded-md overflow-hidden flex flex-col">
                    ...
                    <div class="p-4 flex-grow">
                        ...
                        <p class="text-gray-600 text-sm flex">
                            ...
                            <span> Integrasi Pajak Pasca Transaksi</span>
                        </p>
                    </div>
                ...
                <div class=" bg-white  border border-danger-300 rounded-md overflow-hidden flex flex-col">
                    ...
                    <div class="p-4 flex-grow">
                        ...
                        <p class="text-gray-600 text-sm flex">
                            ...
                            <span> Pelaksanaan Laporan KPPK</span>
                        </p>
                    </div>
