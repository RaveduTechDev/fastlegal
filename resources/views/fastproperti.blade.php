            ...
            <div class="relative grid grid-cols-1 md:grid-cols-2 max-w-screen-xl mx-auto p-6 text-white">
                <div>
                    ...
                    <p class="text-base md:text-lg mb-16">
                        FASTPROPERTI membantu anda dalam pengurusan surat – surat seputar tanah dan properti. Dengan dibantu
                        oleh tenaga professional dan berdedikasi kami sangat bangga melayani anda.
                    </p>
                </div>
            </div>
        </section>
    ...
    <main>
        <section class="relative max-w-screen-xl -mt-24 mx-auto p-6">
            <div class="bg-white shadow-custom2 rounded-lg p-6">
                <h2 class="text-xl md:text-2xl font-semibold font-jakartaEuy mb-4">Layanan FASTPROPERTI</h2>
                <table class="divide-y divide-gray-200 min-w-full">
                    <tbody class="bg-white divide-y divide-gray-200">
                        <tr class="border-y ">
                            <td class="py-2">Pengurusan Balik Nama BPN</td>
                        ...
                        <tr class="border-y">
                            <td class="py-2">Pengurusan Ahli Waris Tanah</td>
                            <td class="py-2 whitespace-nowrap text-right">
                                <a href="{{ url('https://api.whatsapp.com/send?phone=6281294924995&text=Halo,%20saya%20ingin%20bertanya%20mengenai%20layanan%20FASTLEGAL') }}"
                                    class="inline-flex items-center px-4 py-2 border border-transparent transition text-xs md:text-sm font-medium rounded-md text-white bg-danger-300 hover:bg-danger-700"
                                    target="_blank">
                        ...
                        <tr class="border-y">
                            <td class="py-2">Pengurusan Akta Balik Nama</td>
                            <td class="py-2 whitespace-nowrap text-right">
                                <a href="{{ url('https://api.whatsapp.com/send?phone=6281294924995&text=Halo,%20saya%20ingin%20bertanya%20mengenai%20layanan%20FASTLEGAL') }}"
                                    class="inline-flex items-center px-4 py-2 border border-transparent transition text-xs md:text-sm font-medium rounded-md text-white bg-danger-300 hover:bg-danger-700"
                                    target="_blank">
                        ...
                        <tr class="border-y">
                            <td class="py-2">Pengurusan Akta Jual – Beli </td>
                            <td class="py-2 whitespace-nowrap text-right">
                                <a href="{{ url('https://api.whatsapp.com/send?phone=6281294924995&text=Halo,%20saya%20ingin%20bertanya%20mengenai%20layanan%20FASTLEGAL') }}"
                                    class="inline-flex items-center px-4 py-2 border border-transparent transition text-xs md:text-sm font-medium rounded-md text-white bg-danger-300 hover:bg-danger-700"
                                    target="_blank">
                        ...
                        <tr class="border-y">
                            <td class="py-2">Peningkatan Hak Guna Bangunan</td>
                            <td class="py-2 whitespace-nowrap text-right">
                                <a href="{{ url('https://api.whatsapp.com/send?phone=6281294924995&text=Halo,%20saya%20ingin%20bertanya%20mengenai%20layanan%20FASTLEGAL') }}"
                                    class="inline-flex items-center px-4 py-2 border border-transparent transition text-xs md:text-sm font-medium rounded-md text-white bg-danger-300 hover:bg-danger-700"
                                    target="_blank">
                        ...
                        <tr class="border-y">
                            <td class="py-2">Perpanjangan Hak Guna Bangunan</td>
                            <td class="py-2 whitespace-nowrap text-right">
                                <a href="{{ url('https://api.whatsapp.com/send?phone=6281294924995&text=Halo,%20saya%20ingin%20bertanya%20mengenai%20layanan%20FASTLEGAL') }}"
                                    class="inline-flex items-center px-4 py-2 border border-transparent transition text-xs md:text-sm font-medium rounded-md text-white bg-danger-300 hover:bg-danger-700"
                                    target="_blank">
                        ...
                        <tr class="border-y">
                            <td class="py-2">Pengurusan Girik ke SHM</td>
                            <td class="py-2 whitespace-nowrap text-right">
                                <a href="{{ url('https://api.whatsapp.com/send?phone=6281294924995&text=Halo,%20saya%20ingin%20bertanya%20mengenai%20layanan%20FASTLEGAL') }}"
                                    class="inline-flex items-center px-4 py-2 border border-transparent transition text-xs md:text-sm font-medium rounded-md text-white bg-danger-300 hover:bg-danger-700"
                                    target="_blank">
                        ...
                        <tr class="border-y">
                            <td class="py-2">Pemecahan Sertipikat</td>
                            <td class="py-2 whitespace-nowrap text-right">
                                <a href="{{ url('https://api.whatsapp.com/send?phone=6281294924995&text=Halo,%20saya%20ingin%20bertanya%20mengenai%20layanan%20FASTLEGAL') }}"
                                    class="inline-flex items-center px-4 py-2 border border-transparent transition text-xs md:text-sm font-medium rounded-md text-white bg-danger-300 hover:bg-danger-700"
                                    target="_blank">
